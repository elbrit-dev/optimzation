    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="left" className="flex h-[100dvh] w-[92vw] max-w-[42rem] flex-col overflow-hidden rounded-r-[32px] p-0 sm:w-[38rem] [&>button]:hidden">
        <div className="shrink-0 flex items-center justify-between px-4 pb-2 pt-5">
          {/* Radix Title/Description, not a bare h2 + nothing: the dialog needs both
              to be labelled and described, or it logs an a11y warning per open. */}
          <SheetTitle className="text-[2rem] font-semibold tracking-tight text-slate-950">
            Scheduler
          </SheetTitle>
          <SheetDescription className="sr-only">
            Switch the calendar view and choose whose calendars are shown.
          </SheetDescription>
          <SheetClose asChild>
            <button
              type="button"
